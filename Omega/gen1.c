...
{
  switch(index) {
  case RS_ZORCH:strcpy(Str4,LS(IDS_MSG_22771));break;
  case RS_COURT:strcpy(Str4,LS(IDS_MSG_22772)); break;
  case RS_CIRCLE:strcpy(Str4,LS(IDS_MSG_22773));
    break;
  case RS_MAGIC_ISLE: strcpy(Str4,LS(IDS_MSG_22774));
    break;
  case RS_STARPEAK: strcpy(Str4,LS(IDS_MSG_22775));
    break;
  case RS_VOLCANO: strcpy(Str4,LS(IDS_MSG_22776)); break;
  case RS_HIGHASTRAL: strcpy(Str4,LS(IDS_MSG_22777)); break;
  case RS_EARTHPLANE: strcpy(Str4,LS(IDS_MSG_22778)); break;
  case RS_WATERPLANE: strcpy(Str4,LS(IDS_MSG_22779)); break;
  case RS_FIREPLANE: strcpy(Str4,LS(IDS_MSG_22780)); break;
  case RS_AIRPLANE: strcpy(Str4,LS(IDS_MSG_22781)); break;
  case RS_KITCHEN: strcpy(Str4,LS(IDS_MSG_22782)); break;
  case RS_BATHROOM: strcpy(Str4,LS(IDS_MSG_22783)); break;
  case RS_BEDROOM: strcpy(Str4,LS(IDS_MSG_22784)); break;
  case RS_DININGROOM: strcpy(Str4,LS(IDS_MSG_22785)); break;
  case RS_SECRETPASSAGE: strcpy(Str4,LS(IDS_MSG_22786)); break;
  case RS_CLOSET: strcpy(Str4,LS(IDS_MSG_22787)); break;
  case RS_ARENA: strcpy(Str4,LS(IDS_MSG_22788)); break;
  case RS_DROWNED_SEWER: strcpy(Str4,LS(IDS_MSG_22789)); break;
  case RS_DRAINED_SEWER: strcpy(Str4,LS(IDS_MSG_22790)); break;
  case RS_SEWER_DUCT: strcpy(Str4,LS(IDS_MSG_22791)); break;
  case RS_DESTINY: strcpy(Str4,LS(IDS_MSG_22792)); break;
  case RS_DRUID: strcpy(Str4,LS(IDS_MSG_22793)); break;
  case RS_HECATE: strcpy(Str4,LS(IDS_MSG_22794)); break;
  case RS_SET: strcpy(Str4,LS(IDS_MSG_22795)); break;
  case RS_ATHENA: strcpy(Str4,LS(IDS_MSG_22796)); break;
  case RS_ODIN: strcpy(Str4,LS(IDS_MSG_22797)); break;
  case RS_ADEPT: strcpy(Str4,LS(IDS_MSG_22798)); break;
  case RS_WYRM: strcpy(Str4,LS(IDS_MSG_22799)); break;
  case RS_OCEAN: strcpy(Str4,LS(IDS_MSG_22800)); break;
  case RS_PONDS: strcpy(Str4,LS(IDS_MSG_22801)); break;
  case RS_DRAGONLORD: strcpy(Str4,LS(IDS_MSG_22802)); break;
  case RS_GOBLINKING: strcpy(Str4,LS(IDS_MSG_22803)); break;
  case RS_CAVERN: strcpy(Str4,LS(IDS_MSG_22804)); break;
  case RS_CORRIDOR: strcpy(Str4,LS(IDS_MSG_22805)); break;
  case RS_WALLSPACE: strcpy(Str4,LS(IDS_MSG_22806)); break;
  case ROOMBASE+0: strcpy(Str4,LS(IDS_MSG_22807)); break;
  case ROOMBASE+1: strcpy(Str4,LS(IDS_MSG_22808)); break;
  case ROOMBASE+2: strcpy(Str4,LS(IDS_MSG_22809)); break;
  case ROOMBASE+3: strcpy(Str4,LS(IDS_MSG_22810)); break;
  case ROOMBASE+4: strcpy(Str4,LS(IDS_MSG_22811)); break;
  case ROOMBASE+5: strcpy(Str4,LS(IDS_MSG_22812)); break;
  case ROOMBASE+6: strcpy(Str4,LS(IDS_MSG_22813)); break;
  case ROOMBASE+7: strcpy(Str4,LS(IDS_MSG_22814)); break;
  case ROOMBASE+8: strcpy(Str4,LS(IDS_MSG_22815)); break;
  case ROOMBASE+9: strcpy(Str4,LS(IDS_MSG_22816)); break;
  case ROOMBASE+10: strcpy(Str4,LS(IDS_MSG_22817)); break;
  case ROOMBASE+11: strcpy(Str4,LS(IDS_MSG_22818)); break;
  case ROOMBASE+12: strcpy(Str4,LS(IDS_MSG_22819)); break;
  case ROOMBASE+13: strcpy(Str4,LS(IDS_MSG_22820)); break;
  case ROOMBASE+14: strcpy(Str4,LS(IDS_MSG_22821)); break;
  case ROOMBASE+15: strcpy(Str4,LS(IDS_MSG_22822)); break;
  case ROOMBASE+16: strcpy(Str4,LS(IDS_MSG_22823)); break;
  case ROOMBASE+17: strcpy(Str4,LS(IDS_MSG_22824)); break;
  case ROOMBASE+18: strcpy(Str4,LS(IDS_MSG_22825)); break;
  case ROOMBASE+19: strcpy(Str4,LS(IDS_MSG_22826)); break;
  case ROOMBASE+20: strcpy(Str4,LS(IDS_MSG_22827)); break;
  case ROOMBASE+21: strcpy(Str4,LS(IDS_MSG_22828)); break;
  case ROOMBASE+22: strcpy(Str4,LS(IDS_MSG_22829));break;
  case ROOMBASE+23: strcpy(Str4,LS(IDS_MSG_22830));break;
  case ROOMBASE+24: strcpy(Str4,LS(IDS_MSG_22831)); break;
  case ROOMBASE+25: strcpy(Str4,LS(IDS_MSG_22832));break;
  case ROOMBASE+26: strcpy(Str4,LS(IDS_MSG_22833)); break;
  case ROOMBASE+27: strcpy(Str4,LS(IDS_MSG_22834)); break;
  case ROOMBASE+28: strcpy(Str4,LS(IDS_MSG_22835));break;
  case ROOMBASE+29: strcpy(Str4,LS(IDS_MSG_22836));
    break;
  default: strcpy(Str4,LS(IDS_MSG_22837)); break;
  }
  return(Str4);
}
